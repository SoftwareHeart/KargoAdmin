    ...
    function initForkliftAnimation() {
        ...
        function runAnimation() {
            ...
            setTimeout(() => {
                ...
                palletClone.style.width = computedStyle.width;
                palletClone.style.height = computedStyle.height;
                ...
                setTimeout(() => {
                    palletClone.style.top = (palletRect.top - sectionRect.top) + 'px'; // Normal pozisyona düş
